...
namelist = ["Sun", "Venus", "Mercury""Earth", "Moon", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto",
            "JWST"]  # namelist for planets
with open('planet_data.csv', newline='') as csvfile:
    ...
    for row in reader:
        ...
        planet_array.append(p.Planet(xpos * 1e3, ypos * 1e3, zpos * 1e3, xvel * 1e3, yvel * 1e3, zvel * 1e3,
                                     mass))  # numbers from JPL Horizons are in km , 1e3 turns it into metres
